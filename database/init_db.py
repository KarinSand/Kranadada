...
with sqlite3.connect(DB) as conn:
    ...
    ("Terroattacken 11 september",                 2001, "historia", ""), 
      ("Romerska rikets fall",                       476,  "historia", ""),
    ("Muhammeds bortgång",                         632,  "historia", ""),
    ("Slaget vid Tours",                           732,  "historia", ""),
    ("Vikingatåget mot Lindisfarne",               793,  "historia", ""),
    ("Fördraget i Verdun",                         843,  "historia", ""),
    ("Tysk-romerska rikets grundande",             962,  "historia", ""),
    ("Kievriket kristnas",                         988,  "historia", ""),
    ("Stockholms blodbad",                         1520, "historia", ""),
    ("Gustav Vasas fälttåg i Sverige",             1521, "historia", ""),
    ("Fördraget i Westfalen",                      1648, "historia", ""),
    ("Stockholms olympiaden",                      1912, "historia", ""),
    ("Titanic sjunker",                            1912, "historia", ""),
    ("Versaillesfreden",                           1919, "historia", ""),
    ("Börskraschen i USA",                         1929, "historia", ""),
    ("Andra världskrigets början",                 1939, "historia", ""),
    ("Andra världskrigets slut",                   1945, "historia", ""),
    ("FN bildas",                                  1945, "historia", ""),
    ("Första atombomben fälls",                    1945, "historia", ""),
    ("Kalla kriget inleds",                        1947, "historia", ""),
    ("Nato bildas",                                1949, "historia", ""),
    ("Stockholms tunnelbana öppnas",               1950, "historia", ""),
    ("Koreakriget utbryter",                       1950, "historia", ""),
    ("Dag Hammarskjöld blir FN:s generalsekreterare", 1953, "historia", ""),
    ("Bandungkonferensen",                         1955, "historia", ""),
    ("Suezkrisen",                                 1956, "historia", ""),
    ("Rymdkapplöpningen börjar",                    1957, "historia", ""),
    ("Kubakrisen",                                 1962, "historia", ""),
    ("Martin Luther King Jr. håller sitt 'I have a dream'-tal", 1963, "historia", ""),
    ("Olof Palme blir statsminister i Sverige",    1969, "historia", ""),
    ("Månrlandningen",                             1969, "historia", ""),
    ("Watergateaffären börjar",                    1972, "historia", ""),
    ("Tjernobylkatastrofen",                       1986, "historia", ""),
    ("Nelson Mandela friges",                      1990, "historia", ""),
    ("Bill Clinton blir USA:s president",          1993, "historia", ""),
    ("Apartheid faller i Sydafrika",               1994, "historia", ""),
    ("Sveriges inträde i EU",                      1995, "historia", ""),
    ("IT-bubblan spricker",                        2000, "historia", ""),
    ("Tsunamin i Indiska oceanen",                 2004, "historia", ""),
    ("Londonbombningarna",                         2005, "historia", ""),
    ("Finanskrisen inleds",                        2007, "historia", ""),
    ("Barack Obama blir USA:s president",          2009, "historia", ""),
    ("Arabvåren börjar",                           2010, "historia", ""),
    ("Annekteringen av Krim",                      2014, "historia", ""),
    ("Ebolautbrottet i Västafrika",                2014, "historia", ""),
    ("Parisavtalet undertecknas",                  2015, "historia", ""),
    ("Brexit-folkomröstningen",                    2016, "historia", ""),
    ("Donald Trump blir USA:s president",          2017, "historia", ""),
    ("COVID-19-pandemin inleds",                   2019, "historia", ""),
    ("Ungdomsprotesterna i Hongkong",              2019, "historia", ""),
    ("Talibanstyret återtar Kabul",                2021, "historia", ""),
    ("Rysslands invasion av Ukraina",              2022, "historia", "")
